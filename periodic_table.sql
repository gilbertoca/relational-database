...
--
-- Name: elements symbol_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: properties atomic_number_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
